...
import com.gig.collide.api.favorite.request.condition.FolderQueryCondition;
...
public class FolderQueryRequest extends BaseRequest {
    ...
    private List<FolderQueryCondition> conditions;
     ...
     * 是否升序排序
     */
    @Schema(description = "是否升序排序", example = "true")
