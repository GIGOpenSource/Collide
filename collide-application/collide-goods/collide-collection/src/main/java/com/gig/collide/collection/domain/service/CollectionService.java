package com.gig.collide.collection.domain.service;
...
public interface CollectionService extends IService<Collection> {
     ...
     * 新的实现方式见 {@link com.gig.collide.collection.domain.service.impl.HeldCollectionService#create(HeldCollectionCreateRequest)}
     */
    @Deprecated
