...
public interface UserMapper {
     ...
     * 根据ID查询用户（基础信息，性能优化版）
     */
    User findByIdBasic(@Param("id") Long id);
    ...
    /**
     * 用户登录验证并更新登录信息（一次性操作，性能优化版）
     */
    User loginAndUpdateTime(@Param("username") String username, @Param("passwordHash") String passwordHash);
